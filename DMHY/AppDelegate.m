...
NSString *const ContentNameKey = @"moe~yaqinking~dmhy";
NSString *const ApplicationDocumentsDirectoryName = @"DMHY.sqlite";
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"DMHY" withExtension:@"momd"];
...
//    NSDictionary *storeOptions = @{NSPersistentStoreUbiquitousContentNameKey: ContentNameKey};
    ...
    if (! (store = [ _persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:0 URL:storeURL options:0 error:&error])) {
...
- (void) registeLocalNotification {
    ...
    localNotification.alertBody = @"主人，新番更新了喵～";
